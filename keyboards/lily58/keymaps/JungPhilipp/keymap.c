 ...
 */
[_SYM] = LAYOUT(
   KC_GRV, KC_AT,   KC_MPRV, KC_MPLY, KC_MNXT, KC_MSTP,                     KC_VOLD, KC_MUTE, KC_VOLU, _______, _______, _______,
  _______, KC_QUOT, KC_LBRC, KC_EQL , KC_RBRC, KC_MINS,                     _______, _______, _______, _______, _______, _______,
  _______, KC_NUHS, KC_LPRN, KC_PIPE, KC_RBRC, KC_PLUS,                     _______, _______, _______, _______, _______, _______,
  _______, KC_BSLS, KC_LCBR, KC_AMPR, KC_RBRC, KC_SLSH,  _______, _______,  _______, _______, _______, _______, _______, _______,
                             _______, _______, _______,  _______, _______,  _______, _______, _______
),
